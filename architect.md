...
- **ui/api/complex-deltas.js** — компонент таблицы "Комплексные дельты" с колонками CDH, CD6..CD1. Использует заглушки для CD значений до миграции Этапа 3. Поддерживает сортировку по колонкам.
